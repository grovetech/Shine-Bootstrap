                ...
                <div class="yui-b"><div class="yui-g">
                    ...
                    <div class="block tabs spaces">
                        <div class="hd">
							...
							<ul>
								<li class="active"><a href="tickets-app-summary.php?id=<?PHP echo htmlspecialchars($app->id); ?>"><?PHP echo htmlspecialchars($app->name); ?> Summary</a></li>
								<li><a href="tickets-tickets.php?app_id=<?PHP echo htmlspecialchars($app->id); ?>">Tickets</a></li>
								<li><a href="tickets-milestones.php?app_id=<?PHP echo htmlspecialchars($app->id); ?>">Milestones</a></li>
							</ul>
							<div class="clear"></div>
                        </div>
                        <div class="bd">
