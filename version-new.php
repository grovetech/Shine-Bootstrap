                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
							...
							<form action="version-new.php?id=<?PHP echo htmlspecialchars($app->id); ?>" method="post" enctype="multipart/form-data">
								<p><label for="version_number">Sparkle Version Number</label> <input type="text" name="version_number" id="version_number" value="<?PHP echo htmlspecialchars($v)ersion_number;?>" class="form-control"></p>
