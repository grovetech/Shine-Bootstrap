...
<?PHP foreach($apps as $a) : ?>
                                        ...
                                        <tr>
                                            <td><a href="application.php?id=<?PHP echo htmlspecialchars($a->id);?>"><?PHP echo htmlspecialchars($a->name); ?></a></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
        							...
        							<tr>
        							    ...
        							    <td><a href="mailto:<?PHP echo htmlspecialchars($o->payer_email); ?>"><?PHP echo $o->payer_email; ?></a></td>
